...
``` {r timeseries, echo = TRUE, results = "hide"}
...
The average total number of steps taken per day after dealing with the NAs is **`r new_meanSteps`**
  
``` {r median, echo = TRUE}
new_medianSteps <- median(new_totalSteps$sum)
```
And the median value for the total number of steps taken per day after missing values are imputed is **`r new_medianSteps`**.
